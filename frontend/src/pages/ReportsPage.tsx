...
export const ReportsPage: React.FC = () => {
  ...
  const completedResearch = researchHistory.filter(r => r.status === 'completed');

  const downloadReport = (research: any) => {
    const content = `# Market Research Report: ${research.research_topic}
...
## Executive Summary
This research was conducted using AI-powered multi-agent analysis.
...
- RAG-enhanced knowledge base integration
- Real-time data collection and analysis

---
Generated by Market Research AI
`;
    ...
    a.href = url;
    a.download = `${research.research_topic.replace(/\s+/g, '-')}-report.md`;
                  ...
                  >
                    <div className="bg-dark-700 p-4 rounded-lg">
                      ...
                      <p className="text-gray-300 text-sm">
                        This report contains comprehensive market analysis for "{research.research_topic}" 
